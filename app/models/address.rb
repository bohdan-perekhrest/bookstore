...
class Address < ApplicationRecord
  ...
  validates :first_name, :last_name, :country, :city, format: { with: /\A[a-zA-Z]{0,50}\z/, message: I18n.t('validation.address.flccf_format') }
  ...
  validates :first_name, :last_name, :country, :city, :address, length: { maximum: MAX_LENGTH, message: I18n.t('validation.address.flccf_length') }
